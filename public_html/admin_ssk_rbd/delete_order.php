...
$mail->SetFrom("support@malgadi.co.in");
	...
	$mail->Body = "<div>Hello ".$a['fname'].",<br>Your order of <b>".$aa['title']."</b> with Order ID: ".$a['odid']." has been canceled.<br>Let make us aware with the reason of order cancellation.<br>visit again... :)<br>www.malgadi.co.in</div>";
