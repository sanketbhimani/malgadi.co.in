...
<html>
<body>
try msg= (status='delivered',  status='dispatched' or  status='placed')<br>
...
$q = "SELECT * FROM `orders` WHERE ".$msg;
$r = mysql_query($q);
...
$a_count--;
	...
	<td><a href="change_status.php?od_index=<?php echo($a['od_index']); ?>&flg=3">placed</a>
	<a href="change_status.php?od_index=<?php echo($a['od_index']); ?>&flg=1">dispattched</a>
	<a href="change_status.php?od_index=<?php echo($a['od_index']); ?>&flg=2">delivered</a></td>
