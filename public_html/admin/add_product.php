...
include("../connection.php");
	...
	$q = "INSERT INTO `items` (`title`,`subtitle`,`item_avil`,`tags`,`description`,`department`,`price`,`discount`) VALUES ('".$title."','".$subtitle."','".$item_avil."','".$tags."','".$description."','".$department."','".$price."','".$discount."')";
	mysql_query($q)
