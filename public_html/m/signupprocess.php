...
if($_POST['fname'] == null ||  $_POST["email"] == null || $_POST["password"] == null || $_POST['cpassword'] == null || $_POST["mob_no"]==null){
...
echo(7);
$date=date('Y-m-d');
$statement=$connection->prepare("insert into users(fname,email,password,phone_no,date) values(?,?,?,?,?)");
if($statement->execute(array($_POST['fname'],$_POST['email'],$_POST['password'],$_POST['mob_no'],$date))){
    session_start();
    $_SESSION['user_email']=$_POST['email'];
    $_SESSION['user_full_name']=$_POST['fname'];
